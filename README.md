...
As the **Lead Developer**, I oversaw the end-to-end development of the system, with a primary focus on system architecture and hardware-software integration:
...
**Ahmed asiri** | Computer Engineering Graduate (2026) King Khalid University
